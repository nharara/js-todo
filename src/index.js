...
import { todosManager, domManipulator, notesManager } from "./todoFn.js"
...
if (!localStorage.getItem('todos')) {
  todos.home.push(todosManager.createToDo("brush teeth", "low", "2023-11-09", " with colgate", "home", true));
  todos.home.push(todosManager.createToDo("get dressed", "high", "2023-11-09", "singlet cos its hot", "home"));
  todos.home.push(todosManager.createToDo("feed jimmy", "medium", "2023-11-09", "only the finest bickies", "home", true));

  todos.today.push(todosManager.createToDo("get mail", "medium", "2023-11-09", "im expecting something", "today"));
  todos.today.push(todosManager.createToDo("cook dinner", "medium", "2023-11-09", "juicy steak", "today", true));

  todos.week.push(todosManager.createToDo("sport", "medium", "2023-11-09", "", "week"));

  todos.Gym.push(todosManager.createToDo("swim", "medium", "2023-11-09", "", "Gym", true));
  todos.Gym.push(todosManager.createToDo("walk", "high", "2023-11-09", "", "Gym"));
  todos.Gym.push(todosManager.createToDo("weights", "low", "2023-11-09", "", "Gym"));

  todos.Study.push(todosManager.createToDo("learn webkit", "high", "2023-11-09", "", "Study", true));
  todos.Study.push(todosManager.createToDo("learn react", "medium", "2023-11-09", "", "Study"));

  todos.Work.push(todosManager.createToDo("get that report on johnson's desk", "low", "2023-11-09", "", "Work"));
}
